...
const Detail = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView>
      <View className="pt-8 w-full h-full bg-[#F9F9F9]">
        ...
        <View className="mx-8 flex flex-row justify-between items-center py-6 border-b-2 border-[#E3E3E3]">
            ...
            <View className="flex flex-row gap-4 items-center">
                ...
                <TouchableOpacity activeOpacity={0.8} className="bg-[#EDEDED] p-4 rounded-xl">
                    <Image 
                        source={icons.bean}
                        className="w-8 h-8"
                    />
        ...
        <View className="p-8 flex flex-row justify-between mt-auto mb-4 bg-white rounded-t-3xl">
            <View>
